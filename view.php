...
// String
if ($type == 'string') { ?>
<?php //php echo('<pre>'); var_dump(json_decode($value, true)); echo('</pre>');?>
<table>
<tr><td><div id="myjson" class=data><?php echo format_html($value)?></div></td><td><div>
...
<hr>
    ...
    <p id="json-note"></p>
    <textarea hidden id="json"><?=$value?></textarea><br/>
